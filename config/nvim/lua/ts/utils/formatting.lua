...
---@class ts.utils.format
---@overload fun(opts?: {force?:boolean})
-- Local Plugin that wraps formatters and enables quick toggling auto format quickly
...
function M.formatexpr()
	if common_utils.has("conform.nvim") then
...
function M.format(opts)
	...
	if not done and opts and opts.force then
		vim.notify("No formatter available", "warn", { title = "Formatter" })
	end
end
